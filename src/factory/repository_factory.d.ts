...
declare class RepoFactory {
    static getSql<ModelClass extends BaseModel, Props extends BaseProps>(modelClass: StaticSqlModel<ModelClass>): SQLRepo<ModelClass, Props>;
